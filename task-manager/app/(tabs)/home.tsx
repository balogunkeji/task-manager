import {SafeAreaView, StyleSheet, View, TouchableOpacity, TouchableWithoutFeedback} from "react-native";
    ...
    return(
        <SafeAreaView style={styles.container}>
           <View style={styles.tasksContainer}>
            ...
            <ReusableBottomSheet ref={bottomSheetRef2}  onChange={handleSheetChange} snapPoints={['25%']}>
